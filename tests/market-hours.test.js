...
describe('Market Hours', () => {
  ...
  describe('getISTTime', () => {
    test('should return correct IST components', () => {
      ...
      expect(ist.day).toBe(4); // Thursday
      expect(ist.dateStr).toBe('2026-03-05');
  ...
  describe('isWeekend', () => {
    ...
    test('should return false for Wednesday', () => {
      const wed = istDate('2026-03-05', '10:00'); // Wednesday
  ...
  describe('isMarketHoliday', () => {
    ...
    test('should return false for a regular trading day', () => {
      const normal = istDate('2026-03-05', '10:00');
  ...
  describe('isTradingDay', () => {
    test('should return true for regular weekday', () => {
      expect(isTradingDay(istDate('2026-03-05', '10:00'))).toBe(true);
    });
  ...
  describe('isMarketOpen', () => {
    test('should return true during market hours (10:00 AM)', () => {
      expect(isMarketOpen(istDate('2026-03-05', '10:00'))).toBe(true);
    });

    test('should return true at market open (9:15 AM)', () => {
      expect(isMarketOpen(istDate('2026-03-05', '09:15'))).toBe(true);
    });

    test('should return false before market open (9:14 AM)', () => {
      expect(isMarketOpen(istDate('2026-03-05', '09:14'))).toBe(false);
    });

    test('should return false at market close (3:30 PM)', () => {
      expect(isMarketOpen(istDate('2026-03-05', '15:30'))).toBe(false);
    });
  ...
  describe('isPreMarket', () => {
    test('should return true during pre-market (9:00 - 9:15)', () => {
      expect(isPreMarket(istDate('2026-03-05', '09:05'))).toBe(true);
    });

    test('should return false before pre-market (8:59)', () => {
      expect(isPreMarket(istDate('2026-03-05', '08:59'))).toBe(false);
    });

    test('should return false at market open (9:15)', () => {
      expect(isPreMarket(istDate('2026-03-05', '09:15'))).toBe(false);
    });
  });
  ...
  describe('isSquareOffTime', () => {
    test('should return true at 3:15 PM', () => {
      expect(isSquareOffTime(istDate('2026-03-05', '15:15'))).toBe(true);
    });

    test('should return true at 3:20 PM', () => {
      expect(isSquareOffTime(istDate('2026-03-05', '15:20'))).toBe(true);
    });

    test('should return false before 3:15 PM', () => {
      expect(isSquareOffTime(istDate('2026-03-05', '15:14'))).toBe(false);
    });

    test('should return false at/after 3:30 PM', () => {
      expect(isSquareOffTime(istDate('2026-03-05', '15:30'))).toBe(false);
    });
  });
  ...
  describe('minutesUntilOpen', () => {
    test('should return positive value before market open', () => {
      const mins = minutesUntilOpen(istDate('2026-03-05', '08:00'));
      expect(mins).toBe(75); // 9:15 - 8:00 = 75 minutes
    });

    test('should return 0 at market open', () => {
      expect(minutesUntilOpen(istDate('2026-03-05', '09:15'))).toBe(0);
    });

    test('should return negative after market open', () => {
      expect(minutesUntilOpen(istDate('2026-03-05', '10:00'))).toBeLessThan(0);
    });
  });

  describe('minutesUntilClose', () => {
    test('should return correct minutes during trading', () => {
      const mins = minutesUntilClose(istDate('2026-03-05', '14:00'));
  ...
  describe('getMarketStatus', () => {
    test('should return OPEN during trading hours', () => {
      const status = getMarketStatus(istDate('2026-03-05', '10:00'));
    ...
    test('should return PRE_MARKET during pre-market session', () => {
      const status = getMarketStatus(istDate('2026-03-05', '09:05'));
    ...
    test('should return SQUARE_OFF during square-off window', () => {
      const status = getMarketStatus(istDate('2026-03-05', '15:20'));
    ...
    test('should return CLOSED when market is closed (after hours)', () => {
      const status = getMarketStatus(istDate('2026-03-05', '17:00'));
